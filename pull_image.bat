...
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -v %CD%:/work lianshufeng/docker-pull -m=docker.jpy.wang -cleanImage=true lianshufeng/llm:unsloth lianshufeng/llm:vllm-cuda12.1 lianshufeng/llm:LLaMA-Factory lianshufeng/llm:fastchat-cpu vllm/vllm-openai
